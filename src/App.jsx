    ...
    <div>
      ...
      <header style={{ backgroundColor: "powderblue" }}>
        <div>
          <h1>무한도전 추억 페이지</h1>
          <div>
            <button onClick={() => showLetters("Jaeseok")}>재석</button>
            <button onClick={() => showLetters("Myungsoo")}>명수</button>
            <button onClick={() => showLetters("Hyungdon")}>형돈</button>
            <button onClick={() => showLetters("Junha")}>준하</button>
            <button onClick={() => showLetters("Hongchul")}>홍철</button>
            <button onClick={() => showLetters("Haha")}>하하</button>
          </div>
        </div>
      </header>
      <main>
            ...
            <form onSubmit={handleAddBtn}>
              ...
              <div>
                ...
                <select value={member} onChange={selectMember} id="select">
                  ...
                  <option value="Jaeseok">재석</option>
                  <option value="Myungsoo">명수</option>
                  <option value="Hyungdon">형돈</option>
                  <option value="Junha">준하</option>
                  <option value="Hongchul">홍철</option>
                  <option value="Haha">하하</option>
                </select>
              </div>
